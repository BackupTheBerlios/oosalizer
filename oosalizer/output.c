...
void write_html_head(char *period, FILE *out_fp)
{
   ...
   fprintf(out_fp,"<!--\n");
   fprintf(out_fp,"*** Generated by OOS [Webalizer]  Ver. %s-%s \n",
      version,editlvl);
   fprintf(out_fp,"    OOS [OSIS Online Shop]                          \n");
   fprintf(out_fp,"    http://www.oos-shop.de/                         \n");
   fprintf(out_fp,"                                                    \n");
   fprintf(out_fp,"    Copyright (c) 2006 by the OOS Development Team. \n");
   fprintf(out_fp," -------------------------------------------------- \n");
   fprintf(out_fp,"    Released under the GNU General Public License   \n");
   fprintf(out_fp," -------------------------------------------------- \n");
   fprintf(out_fp,"    Based on:                                       \n");
   fprintf(out_fp,"-->\n");
   fprintf(out_fp,"<!-- Generated by The Webalizer  Ver. 2.01-10 -->\n");
   fprintf(out_fp,"<!--                                          -->\n");
   ...
   fprintf(out_fp,"<!--                                          -->\n");
   fprintf(out_fp,"<!-- Webalizer Xtended RB13 patch implemented -->\n");
   fprintf(out_fp,"<!--     Copyright 2005-2006 Patrick Frei     -->\n");
   ...
   fprintf(out_fp,"<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">\n");
   fprintf(out_fp,"</HEAD>\n\n");
   ...
   fprintf(out_fp,"<table align=\"center\" cellpadding=\"0\" cellspacing=\"0\" width=\"778\">\n");
   fprintf(out_fp,"<tbody><tr><td colspan=\"2\" height=\"6\"></td></tr>\n");
   fprintf(out_fp,"<tr><td class=\"head\"><a href=\"http://www.oos-shop.de/\">"\
                  "<img src=\"images/logo.png\" border=\"0\" width=\"140\" height=\"179\" "\
                  "alt=\"OOS [OSIS Online Shop]\" title=\" OOS [OSIS Online Shop] \"/></a></td></tr>\n");
   fprintf(out_fp,"<tr><td colspan=\"2\" height=\"6\"></td></tr>\n");
   fprintf(out_fp,"</tbody></table>\n");

   fprintf(out_fp,"<table bgcolor=\"#E8E8E8\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" width=\"778\">\n");
   fprintf(out_fp,"<tbody><tr><td colspan=\"2\" height=\"6\"></td></tr>\n");
   fprintf(out_fp,"<tr><td valign=\"top\">\n");
...
void write_html_tail(FILE *out_fp)
{
   ...
   fprintf(out_fp,"<SMALL>Generated by " \
                  ...
                  "Webalizer-Xtended (RB13)</A> by Patrick Frei based on \n");
   fprintf(out_fp,"<A HREF=\"http://www.mrunix.net/webalizer/\">");
   fprintf(out_fp,"<STRONG>Webalizer Version 2.01-10</STRONG></A>\n");
   ...
   fprintf(out_fp,"</td></tr>\n");
   fprintf(out_fp,"</tbody></table>\n");

   fprintf(out_fp,"<table align=\"center\" cellpadding=\"0\" cellspacing=\"0\" width=\"778\">\n");
   fprintf(out_fp,"<tbody><tr><td colspan=\"2\" height=\"6\"></td></tr>\n");
   fprintf(out_fp,"<tr><td width=\"50\"><a href=\"http://www.oos-shop.de/\" target=\"_blank\">"\
                  "<img src=\"images/logo_footer.png\" alt=\"www.oos-shop.de\" width=\"46\" "
                  "height=\"33\" border=\"0\" /></a></td>\n");
   fprintf(out_fp,"<td class=\"footer\">Diese WebSite wurde mit <a target=\"_blank\" "
                  "href=\"http://www.oos-shop.de/\">OOS [OSIS Online Shop]</a> erstellt. "
                  "<br /><a target=\"_blank\" href=\"http://www.oos-shop.de/\">OOS [OSIS "
                  "Online Shop]</a> ist als freie Software unter der <a target=\"_blank\" "
                  "href=\"http://www.gnu.org/\">GNU/GPL Lizenz</a> erh&auml;tlich.\n");
   fprintf(out_fp,"</td></tr>\n");
   fprintf(out_fp,"</tbody></table>\n");


   /* wind up, this is the end of the file */
   fprintf(out_fp,"\n<!-- OOS [Webalizer] Version %s-%s (Mod: %s) -->\n",
...
void month_links()
{
   ...
   if (ntop_notfound && response[21].count)
      fprintf(out_fp,"<A HREF=\"#ERRORSTATS\">[Code 404]</A>\n");
...
/*********************************************/
/* MONTH_ERROR_TABLE - monthly error table   */
/*********************************************/
...
void month_error_table()
{
   ...
   for (i=0;i<resp_counter;i++) {
      for (j=(i+1);j<resp_counter;j++) {
         if (respnotfound[i].count < respnotfound[j].count) {
             ...
             strncpy(respnotfound[j].respurl,respnotfound[i].respurl,
	             sizeof(respnotfound[j].respurl)-1);
             respnotfound[j].respurl[sizeof(respnotfound[j].respurl)-1]='\0';
             respnotfound[j].count = respnotfound[i].count;
             strncpy(respnotfound[i].respurl,respnotfoundtmp[0].respurl,
	             sizeof(respnotfound[i].respurl)-1);
             respnotfound[i].respurl[sizeof(respnotfound[i].respurl)-1]='\0';
             respnotfound[i].count = respnotfoundtmp[0].count;
	 }
      } 
   }
   
   /* Print a 404 error table */
   fprintf(out_fp,"<TABLE WIDTH=510 BORDER=2 CELLSPACING=1 " \
           "CELLPADDING=1>\n");
   fprintf(out_fp,"<TR><TH HEIGHT=4></TH></TR>\n");
